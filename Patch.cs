...
using EFT.InventoryLogic;
    ...
    public class FireratePatch : ModulePatch
    {
        ...
        Weapon weapon = ___botOwner_0.WeaponManager.CurrentWeapon;
            ...
            if (___botOwner_0.AimingData.LastDist2Target > 22f && weapon.SelectedFireMode != Weapon.EFireMode.single)
            {
            ...
            if (___botOwner_0.AimingData.LastDist2Target <= 18f && weapon.SelectedFireMode != Weapon.EFireMode.fullauto)
            {
